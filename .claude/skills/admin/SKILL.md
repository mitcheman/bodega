...
`${CLAUDE_PLUGIN_ROOT}/scripts/../reference/welcome-email.md`. Substitute:
...
From `${CLAUDE_PLUGIN_ROOT}/scripts/../reference/how-your-store-works.md`. One-pager
...
From `${CLAUDE_PLUGIN_ROOT}/scripts/../reference/announcement-blurb.md`. Short
