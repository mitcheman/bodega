...
`.windsurf/skills/admin/scripts/../reference/welcome-email.md`. Substitute:
...
From `.windsurf/skills/admin/scripts/../reference/how-your-store-works.md`. One-pager
...
From `.windsurf/skills/admin/scripts/../reference/announcement-blurb.md`. Short
