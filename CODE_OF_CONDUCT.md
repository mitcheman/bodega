...
Bodega a harassment-free experience for everyone, regardless of age,
...
reported to the maintainers via the private contact listed in
...
This code applies within all community spaces (GitHub issues, PRs, Discord,
email) and also when an individual is officially representing the community
in public spaces.
