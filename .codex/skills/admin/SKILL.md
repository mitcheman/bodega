...
`.codex/skills/admin/scripts/../reference/welcome-email.md`. Substitute:
...
From `.codex/skills/admin/scripts/../reference/how-your-store-works.md`. One-pager
...
From `.codex/skills/admin/scripts/../reference/announcement-blurb.md`. Short
