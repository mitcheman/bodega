...
`.opencode/skills/admin/scripts/../reference/welcome-email.md`. Substitute:
...
From `.opencode/skills/admin/scripts/../reference/how-your-store-works.md`. One-pager
...
From `.opencode/skills/admin/scripts/../reference/announcement-blurb.md`. Short
